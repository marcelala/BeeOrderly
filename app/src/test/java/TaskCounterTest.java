...
public class TaskCounterTest {
    ...
    @BeforeEach
    public void setUp() {
        testToDoList.addTask(new Task("Debug", "SDA", LocalDate.parse("2022-03-16")));
        testToDoList.addTask(new Task("Test", "Java", LocalDate.parse("2022-03-16")));
        ...
        testToDoList.addTask(new Task("finish him", "IP", LocalDate.parse("2022-03-19")));
        testToDoList.addTask(new Task("empty project", "", LocalDate.parse("2022-03-19")));
    }
